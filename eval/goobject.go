...
func (gfn *GoFuncObject) CallMethod(line string, scope *Scope, method string, args ...Object) Object {
	...
	// Convert the result back to roach Object
...
// Roach language Object to go language Value.
...
// Go language Value to roach language Object(take care of slice object value)
